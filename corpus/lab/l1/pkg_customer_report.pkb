-- L1 hero corpus: package body for customer reporting.
...
--   2. get_segment_summary: GROUP BY customers.legacy_segment, customers.region
--   3. audit_segment_access: %TYPE anchor + SELECT customers.legacy_segment
--
...
AS
    ...
    BEGIN
        -- Read the live legacy_segment value from the table to cross-check
        -- the caller-supplied p_segment (validates it hasn't drifted).
