...
pub trait PlSqlParserBaseListener<'input>:
    ParseTreeListener<'input, PlSqlParserContextType> {

    /**
     * Enter a parse tree produced by \{@link PlSqlParserBaseParser#s}.
     * @param ctx the parse tree
     */
    fn enter_sql_script(&mut self, _ctx: &Sql_scriptContext<'input>) {}
    /**
     * Exit a parse tree produced by \{@link  PlSqlParserBaseParser#s}.
     * @param ctx the parse tree
     */
